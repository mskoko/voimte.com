...
//Proveri dali Email postoji u nasu bazu;
if (!empty($User->UserIDByEmail($Email)['id'])) {
    ...
    $Alert->SaveAlert('You do not have an account with us, please register first. You have the option to register through Facebook', 'error');
